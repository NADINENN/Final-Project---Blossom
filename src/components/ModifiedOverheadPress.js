...
import './ModifiedOverheadPress.css'; 

function ModifiedOverheadPress() {
    ...
    useEffect(() => {
        if (loggedInUser) {
            fetch(`http://localhost:5000/api/exercises/get-recent-sessions?username=${loggedInUser}&exerciseType=modifiedoverheadpress`)
    ...
    const handleSave = () => {
        ...
        const newEntry = {
            ...
            exerciseType: 'modifiedoverheadpress',
            sets: parseInt(sets),  
            reps: parseInt(reps),
    ...
    const checkForSuggestions = (data) => {
        ...
        if (parseInt(sets) > 5) {
            ...
            setSuggestionMessage(randomMessage([
                ...
                "It is suggested to try to achieve 3 to 5 sets for each weight you lift. It might be more beneficial to attempt this modified overhead press with a lower weight next time.",
            ...
            setSuggestionMessage(randomMessage([
                ...
                "It seems like you are ready to challenge yourself more. Consider adding some weight to your modified overhead press.",
    ...
    return (
        <div className="exercise-container">
            ...
            {/* Title */}
            <h1 className="exercise-title">MODIFIED OVERHEAD PRESS</h1>
            ...
            <div className="exercise-description">
                <p>
                The traditional overhead press needs the core to stabilize and uses too much pressure on the core muscles to stabilize. Modifications are needed.
                </p>
                <h3 style={{ textDecoration: "underline" }}>Starting out</h3>
                <p>
                Start with a light weight until you can properly perform 10 modified overhead presses and only then start increasing weights. Instead of a barbell, use dumbbells your your core has strengthened.
                </p>
                <h3 style={{ textDecoration: "underline" }}>Modifications</h3>

                <p>The Overhead Press can be safely performed while sitting down.</p>
                <p>Sit on your bench</p>
            ...
            <div className="exercise-content-container">
                ...
                <div className="exercise-text-container">
                    ...
                    <p className="exercise-text-red">Stand up while liftingy</p>
                    <p className="exercise-text-red">Arch your back</p>
                    <p className="exercise-text-red">Use heavy weights to start</p>
                </div>
                ...
                <div className="exercise-text-container">
                    ...
                    <p className="exercise-text-green">Sit down while doing the exercise</p>
                    <p className="exercise-text-green">Exhale when you push up the weight</p>
                    <p className="exercise-text-green">Use dumbbells to start</p>
                </div>
            </div>
...
export default ModifiedOverheadPress;
