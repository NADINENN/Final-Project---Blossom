...
function Deadlift() {
    ...
    useEffect(() => {
        if (loggedInUser) {
            fetch(`http://localhost:5000/api/exercises/get-recent-sessions?username=${loggedInUser}&exerciseType=deadlift`)
    ...
    const checkForSuggestions = (data) => {
        ...
        if (parseInt(sets) > 5) {
            ...
            setSuggestionMessage(randomMessage([
                ...
                "It is suggested to try to achieve 3 to 5 sets for each weight you lift. It might be more beneficial to attempt this deadlift with a lower weight next time.",
            ...
            setSuggestionMessage(randomMessage([
                ...
                "It seems like you are ready to challenge yourself more. Consider adding some weight to your deadlifts.",
    ...
    return (
        <div className="exercise-container">
            ...
            {/* Title */}
            <h1 className="exercise-title">DEADLIFTS</h1>


            {/* Description */}
            <div className="exercise-description">
                <p>
                    Deadlifts engage several muscle groups and can improve posture, strengthen the posterior chain, and help reduce lower back pain. Deadlifts are performed by lifting a weight off the ground from a bent-over position and then put back down.
                </p>
                <h3 style={{ textDecoration: "underline" }}>Starting out</h3>
                <p>
                    Start with a light weight until you can properly perform 10 deadlifts and only then start increasing weights.
                </p>
                <h3 style={{ textDecoration: "underline" }}>Modifications</h3>
                <p>
                    Start with the weight elevated off the floor, which will increase the angle of the hip hinge. The back needs to be kept straight, and the core engaged. The knees should not be bent, instead hinge at the hip.
                </p>
                <p>Hold the weight with both hands in front of you.</p>
                <p>Exhale and push your hips forward while lifting the weights just below your knee.</p>
                <p>Inhale and lower the weight back to the floor.</p>
            </div>
            ...
            <div className="exercise-content-container">
                ...
                <div className="exercise-text-container">
                    ...
                    <p className="exercise-text-red">Round your back while lifting</p>
                    <p className="exercise-text-red">Lift with your arms instead of your legs</p>
                ...
                <div className="exercise-text-container">
                    ...
                    <p className="exercise-text-green">Breathe in before lifting</p>
                    <p className="exercise-text-green">Keep your back straight and core engaged</p>
                    <p className="exercise-text-green">Lift with your legs and hips</p>
                    <p className="exercise-text-green">Keep the bar close to your body</p>
                </div>
            </div>
